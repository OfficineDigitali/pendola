...
<form class="form-horizontal" method="POST" action="{{ url('entities/' . $entity->id) }}">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<button class="btn btn-default iconpick" name="icon" role="iconpicker" data-iconset="glyphicon" data-icon="glyphicon-{{ $entity->icon }}" data-search="false" data-cols="9"></button>
		</div>
	</div>
